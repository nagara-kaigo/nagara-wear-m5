...
void showLoadingPopup(const AppState &state){
    M5.Lcd.setTextDatum(MC_DATUM);
    M5.Lcd.fillRect(LOADING_POPUP_STARTX, LOADING_POPUP_STARTY, LOADING_POPUP_WIDTH, LOADING_POPUP_HEIGHT, WHITE);
    M5.Lcd.drawRect(LOADING_POPUP_STARTX, LOADING_POPUP_STARTY, LOADING_POPUP_WIDTH, LOADING_POPUP_HEIGHT, BLACK);
    M5.Lcd.drawString("ロード中・・・",LOADING_POPUP_STARTX + LOADING_POPUP_WIDTH/2, LOADING_POPUP_STARTY + LOADING_POPUP_HEIGHT/2);
}